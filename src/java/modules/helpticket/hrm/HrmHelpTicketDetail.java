...
import modules.helpticket.sugar.HelpTicketRemainingTime;

/**
 *
 * @author kajornjit.songsaen
 */
public class HrmHelpTicketDetail {
    ...
    public HrmHelpTicketDetail() throws ProtocolException, IOException {
        JiraReader ticket = new JiraReader();
        JsonObject json = ticket.getHrmTicket();
